...
using fpts.Droid.Renderer;
using fpts.Views;
using fpts.Views.core;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ExportRenderer(typeof(MasterDetailMainviewDetail), typeof(MainviewRenderer))]
namespace fpts.Droid.Renderer
{
    class MainviewRenderer : VisualElementRenderer<MasterDetailMainviewDetail>, IOnTabClickListener
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<MasterDetailMainviewDetail> e)
        {
        ...
        private void InitializeElement(MasterDetailMainviewDetail element)
        {
            PopulateChildren(element);
        }

        private void PopulateChildren(MasterDetailMainviewDetail element)
        {
        ...
        private void ClearElement(MasterDetailMainviewDetail element)
        {
            if (_currentPage != null)
            {
